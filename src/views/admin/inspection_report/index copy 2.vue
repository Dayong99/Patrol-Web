<template>
  <div class="app-container">
    ...
    >
      ...
      >
        <template slot-scope="scope">
          ...
          <div class="icondiv">
            <el-dropdown trigger="hover" size="mini" placement="bottom">
              <img class="more2" />
    ...
    <!-- <div id="wordView" v-html="vHtml" v-show="wordShow"></div> -->
    <div class="pdfView" v-show="wordShow">
...
export default {
  ...
  methods: {
    ...
    // 文件预览
    previewReport(item) {
      // this.pdfUrl = pdf.createLoadingTask(globalConfig.baseURL + '/download?materialId=' + item.id);
